...
var Controller = function(hostname, port)
{
  ...
  {
    var results = [];
    _self._request('/api/login', { username: username, password: password }, results, function(err) {
      cb(err, results[0]);
    });
  };
  ...
  {
    var results = [];
    _self._request('/logout', null, results, function(err) {
  ...
  _self.getAllAuthorizations = function(sites, cb, start, end)
  {
    ...
    async.whilst(
      ...
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/authorization', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getAllUsers = function(sites, cb, within)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/alluser', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getGuests = function(sites, cb, within)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/guest', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getClientDevices = function(sites, cb, client_mac)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/sta/' + client_mac, null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getClientDevice = function(sites, cb, client_mac)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/user/' + client_mac, null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getUserGroups = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/usergroup', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getHealth = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/health', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getHealth = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/dashboard', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getUsers = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/user', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getAccessDevices = function(sites, cb, device_mac)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/device/' + device_mac, null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getRogueAccessPoints = function(sites, cb, within)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/rogueap', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  {
    var results = [];
    _self._request('/api/self/sites', null, results, function(err) {
      cb(err, results[0]);
    });
  };
  ...
  {
    var results = [];
    _self._request('/api/stat/sites', null, results, function(err) {
      cb(err, results[0]);
    });
  };
  ...
  _self.addSite = function(site, cb, description)
  {
    ...
    var results = [];
    _self._request('/api/s/' + site + '/cmd/sitemgr', json, results, function(err) {
      cb(err, results[0]);
    });
  };
  ...
  _self.getWLanGroups = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/wlangroup', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getSiteSysinfo = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/sysinfo', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getSelf = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/self', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getNetworkConf = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/networkconf', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getVouchers = function(sites, cb, create_time)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/voucher', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getPayments = function(sites, cb, within)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/payment' + within, null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.createHotspotOperator = function(sites, name, x_password, cb, note)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/rest/hotspotop', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getHotspotOperators = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/hotspotop', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getPortForwardingStats = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/portforward', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getPortForwarding = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/portforward', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getDynamicDNS = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/dynamicdns', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getPortConfig = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/portconf', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getVoipExtensions = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/extension', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getSiteSettings = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/get/setting', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.disableAccessPoint = function(sites, ap_id, disable, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/rest/device/' + ap_id , json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.setAccessPointRadioSettings = function(sites, ap_id, radio, channel, ht, tx_power_mode, tx_power, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/upd/device/' + ap_id , json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.setGuestLoginSettings = function(sites, portal_enabled, portal_customized, redirect_enabled, redirect_url, x_password, expire_number, expire_unit, site_id, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/set/setting/guest_access/' , json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.setWLanSettings = function(sites, wlan_id, x_passphrase, cb, name)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/upd/wlanconf/' + wlan_id, json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getEvents = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/event', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getWLanSettings = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/wlanconf', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.getAlarms = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/list/alarm', null, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.createBackup = function(sites, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/cmd/backup', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self.upgradeExternalFirmware = function(sites, mac, firmware_url, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/cmd/devmgr/upgrade-external', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self._request = function(url, json, results, cb)
  {
    var reqfunc = request.get;
    var reqjson = {url: _self._baseurl + url};
    var req;
  ...
  _self._setting_mgmt = function(sites, json, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/set/setting/mgmt', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self._cmd_devmgr = function(sites, json, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/cmd/devmgr', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self._cmd_hotspot = function(sites, json, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/cmd/hotspot', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self._stamgr = function(cmd, sites, cb, mac, minutes, up, down, mbytes, ap_mac)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/cmd/stamgr', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self._upd_user = function(sites, user_id, cb, json)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/upd/user/' + user_id, json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self._stat_report_site = function(sites, interval, json, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/report/' + interval + '.site', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
  ...
  _self._stat_session = function(sites, json, cb)
  {
    ...
    async.whilst(
      function() { return count < sites.length; },
      function(callback) {
        _self._request('/api/s/' + sites[count] + '/stat/session', json, results, callback);
        count++;
      },
      function(err) {
        if(!err)
...
controller.login("admin", "XXXXXXXX", function(err) {
  ...
  controller.getSitesStats(function(err, sites) {
    console.log('getSitesStats: ' + sites[0].name);
