/** Names of the DPI categories, by category ID */
export const DPI_CATEGORIES: Readonly<Record<number, string>> = {
...
/** Names of the DPI applications, by `(categoryId << 16) + applicationId` */
export const DPI_APPLICATIONS: Readonly<Record<number, string>> = {
    1: 'MSN',
    2: 'Yahoo Messenger',
    3: 'AIM/ICQ/iIM',
    4: 'QQ/TM',
